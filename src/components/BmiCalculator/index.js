        ...
        <div className='measurements-container'>
          <div className='measurement-card'>
            ...
            <div className='buttons-container'>
              <button className='button' onClick={onDecrementHeight}>
                -
              </button>
              <button className='button' onClick={onIncrementHeight}>
                +
              </button>
            </div>
          </div>
          <div className='measurement-card'>
            ...
            <div className='buttons-container'>
              <button className='button' onClick={onDecrementWeight}>
                -
              </button>
              <button className='button' onClick={onIncrementWeight}>
                +
              </button>
            </div>
          </div>
